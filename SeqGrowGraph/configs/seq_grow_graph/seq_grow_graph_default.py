...
model = dict(
    ...
    flow_matching_cfg=dict(
        ...
        flow_config=dict(
            vector_field_type="attention",
            hidden_channels=transformer_dims,
            time_embed_dim=64,
            attention_hidden_dim=transformer_dims,
            attention_num_layers=4,
            attention_num_heads=max(transformer_dims // head_dims, 1),
            attention_time_embed_dim=transformer_dims,
